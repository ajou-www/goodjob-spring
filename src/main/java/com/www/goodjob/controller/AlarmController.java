...
public class AlarmController {
    ...
    @Operation(
            ...
            description = """
                ...
                - (CV_MATCH 전용) cvId: 매칭 기준 CV ID
                - (CV_MATCH 전용) cvTitle: CV 파일명 스냅샷(예: '프론트')
                ...
                ```json
                {
                  ...
                  "alarmText": "‘프론트’에 대한 오늘의 추천 공고 TOP 5 (90점 이상)",
                  "userId": 140,
                  "read": true,
                  "readAt": "2025-08-20T08:25:56",
                  "type": "CV_MATCH",
                  "dedupeKey": "CV_MATCH_TOPN:140:123:2025-08-21",
                  "status": "QUEUED",
                  ...
                  "params": { "topN": 5, "threshold": 90.0, "cvId": 123, "cvTitle": "프론트" }
                }
                ```
